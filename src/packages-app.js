            ...
            {mobileMenuOpen && (
                <nav className="md:hidden bg-background-light/95 dark:bg-background-dark/95 border-t border-gray-200 dark:border-gray-800 py-4">
                    <div className="container mx-auto px-4 space-y-3">
                        ...
                        <a href="https://wa.me/+919304010727?text=Hi!%20I%27m%20interested%20in%20packages." target="_blank" rel="noopener noreferrer" className="block py-2 px-4 bg-primary text-white rounded font-bold text-center hover:bg-primary/90 transition-colors">Plan Trip</a>
                    </div>
                </nav>
            )}
        </header>
